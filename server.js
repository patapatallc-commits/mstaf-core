...
(function(){
  ...
  form.addEventListener('submit',async function(event){
    ...
    try{
      ...
      fd.set('senderName',prices.join(' | ').slice(0,40));
      fd.set('shopifyListingPrice',usd||eur||'');
      fd.set('africaListingPrice',ngn||'');
