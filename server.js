...
function t(session, key) {
  ...
  const translations = {
    ...
    welcome: {
      en: "👋 Welcome to PATAPATA Print-O-Matic",
      es: "👋 Bienvenido a PATAPATA Print-O-Matic",
      fr: "👋 Bienvenue chez PATAPATA Print-O-Matic",
      pt: "👋 Bem-vindo ao PATAPATA Print-O-Matic",
      ar: "👋 مرحبًا بك في PATAPATA Print-O-Matic"
    },
...
10 - Apartamento compartido
11 - Ayudante interior/exterior
12 - Camisetas personalizadas
13 - Buscar trabajo / CV
14 - Oportunidades laborales
15 - Contratar trabajador
16 - Alerta comunitaria
17 - Proveedores confiables
18 - Comprar terreno
19 - Cambio de divisas
...
9 - Transport travail
10 - Appartement partagé
11 - Aide intérieure/extérieure
12 - Impression T-shirt
13 - Recherche emploi / CV
14 - Opportunités d'emploi
15 - Embaucher un travailleur
16 - Alerte communautaire
17 - Fournisseurs fiables
18 - Acheter terrain
19 - Échange de devises
20 - Créateur réseaux sociaux
21 - Acheter et revendre auto`,

      pt:
`1 - Impressão
2 - Laminação
3 - Foto para documento
4 - Edição de imagem
5 - Edição de vídeo
6 - Aula / Tarefa
7 - Falar com agente
...
10 - Apartamento compartilhado
11 - Ajudante interno/externo
12 - Camisa personalizada
13 - Procurar emprego / CV
...
if (type === "text" && ["hi", "hello", "hey", "menu", "start"].includes(lower)) {
  ...
  freshSession.stage = "LANGUAGE_SELECT";
...
if (session.stage === "LANGUAGE_SELECT") {
  ...
  const selectedLanguage = languageMap[lower];
